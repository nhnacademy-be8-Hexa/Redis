...
import com.nhnacademy.redis.dto.KeyResponseDto;
import com.nhnacademy.redis.exception.KeyManagerException;
    ...
    public String fetchSecretFromKeyManager() {
        try {
            ...
            if (keyStoreInputStream == null) {
                throw new KeyManagerException("Hexa_certificate.p12 not found in classpath at " + keyStoreFilePath);
            }
